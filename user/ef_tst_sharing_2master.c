...
_main(void)
{
	...
	*y = 20 ;
	...
	int id1, id2, id3;
	id1 = sys_create_env("ef_shr2Slave1", (myEnv->page_WS_max_size));
	id2 = sys_create_env("ef_shr2Slave1", (myEnv->page_WS_max_size));
	id3 = sys_create_env("ef_shr2Slave1", (myEnv->page_WS_max_size));
