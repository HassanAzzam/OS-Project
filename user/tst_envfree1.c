...
void _main(void)
{
	...
	*numOfFinished = 0 ;
	...
	//Create 3 processes
	int32 envIdProcessA = sys_create_env("ef_fib", 5);
	int32 envIdProcessB = sys_create_env("ef_fact", 5);
	int32 envIdProcessC = sys_create_env("ef_fos_add", 5);
